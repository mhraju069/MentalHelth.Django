...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    dob = models.DateField(blank=True, null=True,verbose_name="User Date of Birth")
    gender = models.CharField(max_length=10, blank=True, null=True,verbose_name="User Gender")
    location = models.CharField(max_length=100, blank=True, null=True,verbose_name="User Location")
